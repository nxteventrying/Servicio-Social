...
def process_files(data_folder, output_folder, csv_filename, file_limit=None):
    ...
    if file_limit is not None:
        sorted_filenames = sorted_filenames[:file_limit]
...
if __name__ == "__main__":
    # Define folder paths
    data_folder = "All"  # Folder with .txt files
    output_folder = "Plots_Test"       # Folder to save plots
    csv_filename = "Test.csv"   # Output CSV file
    file_limit = 10  # Limit to process only 10 files (None for no limit)
    ...
    process_files(data_folder, output_folder, csv_filename, file_limit)
